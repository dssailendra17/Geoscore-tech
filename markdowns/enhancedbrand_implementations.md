...
Website Content Optimizations - Improve content based on SERP data
Social Media Content Optimizations - Optimize social presence based on engagement data
Enhanced Brand Tracking - Holistic view of brand visibility across all channels
...
3. Social Media Data
Twitter: Mentions, engagement (likes/retweets/replies), sentiment, top tweets LinkedIn: Company page metrics, engagement rates YouTube: Video mentions, view counts, engagement Meta: Social presence tracking
...
GET /api/brands/:brandId/serp/overview
GET /api/brands/:brandId/serp/opportunities
GET /api/brands/:brandId/serp/paa-questions
GET /api/brands/:brandId/serp/position-tracking
...
GET /api/brands/:brandId/knowledge-graph/health
GET /api/brands/:brandId/knowledge-graph/recommendations
...
GET /api/brands/:brandId/social/overview
GET /api/brands/:brandId/social/sentiment-trends
GET /api/brands/:brandId/social/top-content
GET /api/brands/:brandId/social/mentions-velocity
...
"Add FAQ section answering these PAA questions"
"Improve meta description for better CTR"
"Create AXP page for this topic cluster"
"Add schema markup for this content type"
API Endpoints:

GET /api/brands/:brandId/content/optimization-opportunities
GET /api/brands/:brandId/content/paa-recommendations
GET /api/brands/:brandId/content/ctr-improvement-targets
POST /api/brands/:brandId/content/generate-recommendations
...
"Post more video content - 2x engagement vs text"
"Best posting time: Tue 10am, Thu 2pm"
"These hashtags drive 40% more engagement"
"Negative sentiment rising - address these concerns"
API Endpoints:

GET /api/brands/:brandId/social/posting-insights
GET /api/brands/:brandId/social/format-performance
GET /api/brands/:brandId/social/hashtag-analysis
POST /api/brands/:brandId/social/generate-recommendations
